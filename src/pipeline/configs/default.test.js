...
describe('stage helpers', () => {
  ...
  it('createNerSteps returns a single ner phase with hf step (and regex/lexicon when active)', () => {
    ...
    expect(withNeither[0].steps).toHaveLength(6); // ner/case-folded-ner/regex/lexicon/special-category-lexicon/gazetteer steps always exist; regex/lexicon/case-folded/gazetteer are no-ops when inactive/non-qualifying
  });
